    ...
    <div
      className={cn(
        ...
        },
        {
          ...
          'hover:h-24 hover:w-24': size === Size.Medium,
          'hover:h-28 hover:w-28': size === Size.Large,
          'hover:h-32 hover:w-32': size === Size.XLarge,
        },
        {
...
const Inventory = ({ player }: { player: Player }) => {
  ...
  return (
    <div className='grid h-40 w-full grid-cols-3 rounded-2xl border-2 border-black'>
      {[0, 1, 2].map((i) => (
